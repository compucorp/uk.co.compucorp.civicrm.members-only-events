...
-- /*******************************************************
-- *
-- * membersonlyevent_configurations
-- *
-- * Stores members-only event extension system-wide configurations
-- *
-- *******************************************************/
CREATE TABLE `membersonlyevent_configurations` (
     `id` int unsigned NOT NULL AUTO_INCREMENT,
     `membership_duration_check` tinyint   DEFAULT 0  COMMENT 'If True, the extension will check if the user membership is active (valid) at the time of the event',
    PRIMARY KEY ( `id` )
)  ENGINE=InnoDB DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci  ;

-- /*******************************************************
-- *
-- * Adds the default extension system-wide configurations
-- *
-- *******************************************************/
INSERT INTO membersonlyevent_configurations (`membership_duration_check`) VALUES (0);
